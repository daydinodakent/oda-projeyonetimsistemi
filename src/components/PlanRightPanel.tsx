...
import { DollarSign, FileCheck, AlertTriangle, Percent, Activity, Box as BoxIcon, Ruler, Pencil } from 'lucide-react';
    ...
    <Stack spacing={2.5}>
      ...
      <Box
        sx={{
          ...
          border: 1,
          borderColor: alpha(c('warning').main, 0.3),
          backdropFilter: 'blur(4px)',
          boxShadow: 3,
        }}
      >
        <Box sx={{ position: 'absolute', top: 0, right: 0, width: 96, height: 96, borderRadius: '50%', bgcolor: alpha(c('warning').main, 0.06), filter: 'blur(24px)', pointerEvents: 'none' }} />

        <Stack spacing={2.5} sx={{ position: 'relative' }}>
          <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
            <Stack direction="row" spacing={2} sx={{ alignItems: 'center' }}>
              <Box sx={{ width: 20, height: 20, borderRadius: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'warning.main', bgcolor: alpha(c('warning').main, 0.1), border: 1, borderColor: alpha(c('warning').main, 0.2) }}>
          ...
          <Box>
            <Typography component="span" sx={{ ...microLabelSx, letterSpacing: '0.05em', mb: 0.5 }}>Toplam Kübik Hacim</Typography>
          ...
          <Box sx={{ p: 2, fontFamily: 'monospace', bgcolor: alpha(theme.palette.common.black, 0.2), border: 1, borderColor: 'divider', borderRadius: 1 }}>
            <Stack direction="row" sx={{ justifyContent: 'space-between', alignItems: 'center', fontSize: 10 }}>
            ...
            <Slider
              ...
              onChange={(_, v) => setAvgFloorHeight(v as number)}
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2, fontFamily: 'monospace' }}>
            {[
              { label: 'Çizilen Poligon', value: `${currentProjectBuildings.length} Adet` },
              ...
              <Box key={m.label} sx={{ p: 1.5, display: 'flex', flexDirection: 'column', bgcolor: alpha(theme.palette.common.black, 0.15), border: 1, borderColor: 'divider', borderRadius: 1 }}>
                <Typography component="span" sx={{ ...microLabelSx, fontFamily: 'inherit' }}>{m.label}</Typography>
